...
<div class="fixed top-2 z-100 right-2 gap-1 flex flex-col items-end">
  ...
  <a
    ...
    class="bg-[var(--highlite)] text-black font-semibold hover:opacity-80 transition pointer-events-auto leading-none text-xs"
  >
    Contact us
  </a>
</div>
...
{#if smallTextPos.width > 0}
  ...
  >
    ...
    >
      Vantage explores innovative web-based approaches in service of journalism.
    </p>
  </div>
{/if}
